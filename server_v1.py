...
while 1:
    ...
    try:
        ...
        if "scatter" in prediction:
          ...
          print(index1)
          # make the highest decision to None, and then take the second highest
          ...
          if probability > 0.5:
            reply = prediction+" (confident rate is relatively high with probability "+str(probability)+'). The optional prediction is '+predict2+":"+dict[prediction]+'\n'
          else:
            reply = prediction+" (confident rate is relatively low with probability "+str(probability)+'). The optional prediction is '+predict2+":"+dict[prediction]+'\n'
            print(reply)
  
          #reply = prediction + ":" + dict[prediction] + " Confident rate is " + str(probability) + '\n'
